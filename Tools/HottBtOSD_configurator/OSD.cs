...
namespace OSD
{
    public partial class OSD : Form
    {
        ...
        public OSD()
        {
            ...
            try
            {
                bgpicture = Image.FromFile("bg.png");
            }
            catch { }
        ...
        void setupFunctions()
        {
            ...
            //panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Pitch", pan.panPitch,2, 9, panPitch_en_ADDR, panPitch_x_ADDR, panPitch_y_ADDR);
            ...
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Battery B", pan.panBatt_B, 21, 3, panBatt_B_en_ADDR, panBatt_B_x_ADDR, panBatt_B_y_ADDR);
            ...
            //second 8
            //panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Heading Rose", pan.panRose, 10, 15, panRose_en_ADDR, panRose_x_ADDR, panRose_y_ADDR);
            ...
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Home Direction", pan.panHomeDir, 14, 13, panHomeDir_en_ADDR, panHomeDir_x_ADDR, panHomeDir_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Home Distance", pan.panHomeDis, 22, 15, panHomeDis_en_ADDR, panHomeDis_x_ADDR, panHomeDis_y_ADDR);
            ...
            // third 8
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Altitude", pan.panAlt, 22, 1, panAlt_en_ADDR, panAlt_x_ADDR, panAlt_y_ADDR);
            ...
            //panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Vertical Speed", pan.panClimb, 10, 4, panClimb_en_ADDR, panClimb_x_ADDR, panClimb_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Battery Percent", pan.panBatteryPercent, 1, 15, panBatteryPercent_en_ADDR, panBatteryPercent_x_ADDR, panBatteryPercent_y_ADDR);

            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Current", pan.panCur_A, 1, 13, panCur_A_en_ADDR, panCur_A_x_ADDR, panCur_A_y_ADDR);
            ...
            //panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Trip Distance", pan.panDistance, 22, 13, panDistance_en_ADDR, panDistance_x_ADDR, panDistance_y_ADDR);
            ...
            foreach (var thing in panelItems)
            {
                if (thing != null)
                {
                    ...
                    else if (thing.Item1 == "Real heading")
                    {
                        TreeNode tn = LIST_items.Nodes.Add(thing.Item1, thing.Item1);
                        tn.Checked = false;
                    }
                    ...
                    else if (thing.Item1 == "Home Altitude")
                    {
                        TreeNode tn = LIST_items.Nodes.Add(thing.Item1, thing.Item1);
                        tn.Checked = false;
                    }
            ...
            // Display name,printfunction,X,Y,ENaddress,Xaddress,Yaddress
            //            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Center", pan.panCenter, 13, 8, panCenter_en_ADDR, panCenter_x_ADDR, panCenter_y_ADDR);
            //panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Pitch", pan.panPitch, 2, 9, panPitch_en_ADDR, panPitch_x_ADDR, panPitch_y_ADDR);
            ...
            //second 8
            //panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Heading Rose", pan.panRose, 10, 15, panRose_en_ADDR, panRose_x_ADDR, panRose_y_ADDR);
            ...
            //            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Heart Beat", pan.panMavBeat, 14, 15, panMavBeat_en_ADDR, panMavBeat_x_ADDR, panMavBeat_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Home Direction", pan.panHomeDir, 14, 13, panHomeDir_en_ADDR, panHomeDir_x_ADDR, panHomeDir_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Home Distance", pan.panHomeDis, 22, 15, panHomeDis_en_ADDR, panHomeDis_x_ADDR, panHomeDis_y_ADDR);
            //            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("WP Direction", pan.panWPDir, 20, 12, panWPDir_en_ADDR, panWPDir_x_ADDR, panWPDir_y_ADDR);
            //panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("WP Distance", pan.panWPDis, 1, 11, panWPDis_en_ADDR, panWPDis_x_ADDR, panWPDis_y_ADDR);
            // rssi

            // third 8
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Altitude", pan.panAlt, 22, 1, panAlt_en_ADDR, panAlt_x_ADDR, panAlt_y_ADDR);
            ...
            //panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Vertical Speed", pan.panClimb, 10, 4, panClimb_en_ADDR, panClimb_x_ADDR, panClimb_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Battery Percent", pan.panBatteryPercent, 1, 15, panBatteryPercent_en_ADDR, panBatteryPercent_x_ADDR, panBatteryPercent_y_ADDR);

            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Current", pan.panCur_A, 1, 13, panCur_A_en_ADDR, panCur_A_x_ADDR, panCur_A_y_ADDR);
            ...
            //panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Trip Distance", pan.panDistance, 22, 13, panDistance_en_ADDR, panDistance_x_ADDR, panDistance_y_ADDR);

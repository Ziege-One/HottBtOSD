...
//    writeEEPROM(7,  panCenter_y_ADDR + offset);
    writeEEPROM(off, panPitch_en_ADDR + offset);
    writeEEPROM(2, panPitch_x_ADDR + offset);
    writeEEPROM(9,  panPitch_y_ADDR + offset);
    writeEEPROM(off, panRoll_en_ADDR + offset);
    writeEEPROM(11, panRoll_x_ADDR + offset);
    writeEEPROM(1,  panRoll_y_ADDR + offset);
    writeEEPROM(on, panBatt_A_en_ADDR + offset);
    writeEEPROM(1, panBatt_A_x_ADDR + offset);
    writeEEPROM(14,  panBatt_A_y_ADDR + offset);
    writeEEPROM(on, panGPSats_en_ADDR + offset);
    writeEEPROM(26,  panGPSats_x_ADDR + offset);
    writeEEPROM(0, panGPSats_y_ADDR + offset);
    writeEEPROM(off, panGPS_en_ADDR + offset);
    writeEEPROM(3,  panGPS_x_ADDR + offset);
    writeEEPROM(2, panGPS_y_ADDR + offset);
    writeEEPROM(on, panRose_en_ADDR + offset);
    writeEEPROM(10, panRose_x_ADDR + offset);
    writeEEPROM(15, panRose_y_ADDR + offset);
    writeEEPROM(off, panHeading_en_ADDR + offset);
    ...
    writeEEPROM(12, panRSSI_x_ADDR + offset);
    writeEEPROM(1,  panRSSI_y_ADDR + offset);
    writeEEPROM(on, panCur_A_en_ADDR + offset);
    writeEEPROM(1, panCur_A_x_ADDR + offset);
    writeEEPROM(13,  panCur_A_y_ADDR + offset);
    ...
    writeEEPROM(1,  panAlt_y_ADDR + offset);
    writeEEPROM(off, panHomeAlt_en_ADDR + offset);
    ...
    writeEEPROM(1,  panVel_y_ADDR + offset);
    writeEEPROM(off, panAirSpeed_en_ADDR + offset);
    writeEEPROM(1,  panAirSpeed_x_ADDR + offset);
    writeEEPROM(2,  panAirSpeed_y_ADDR + offset); 
    writeEEPROM(on, panBatteryPercent_en_ADDR + offset);
    writeEEPROM(1,  panBatteryPercent_x_ADDR + offset);
    writeEEPROM(15,  panBatteryPercent_y_ADDR + offset); 
    writeEEPROM(on, panTime_en_ADDR + offset);
    writeEEPROM(0,  panTime_x_ADDR + offset);
    writeEEPROM(0,  panTime_y_ADDR + offset);
    // writeEEPROM(off, panThr_en_ADDR + offset);
    // writeEEPROM(2,  panThr_x_ADDR + offset);
    // writeEEPROM(4,  panThr_y_ADDR + offset);
    writeEEPROM(on, panFMod_en_ADDR + offset);
    writeEEPROM(25,  panFMod_x_ADDR + offset);
    writeEEPROM(14, panFMod_y_ADDR + offset);
    ...
    writeEEPROM(0,  panWarn_y_ADDR + offset);
    ...
    writeEEPROM(off, panClimb_en_ADDR + offset);
    // writeEEPROM(10, panClimb_x_ADDR + offset);
    // writeEEPROM(4,  panClimb_y_ADDR + offset);
    writeEEPROM(off, panEff_en_ADDR + offset);
    writeEEPROM(1, panEff_x_ADDR + offset);
    writeEEPROM(11,  panEff_y_ADDR + offset);
    ...
    writeEEPROM(13,  panDistance_y_ADDR + offset);
    writeEEPROM(off, panCALLSIGN_en_ADDR + offset);
    writeEEPROM(4, panCALLSIGN_x_ADDR + offset);
    writeEEPROM(0, panCALLSIGN_y_ADDR + offset);
 
    writeEEPROM(130,overspeed_ADDR);
    writeEEPROM(0,stall_ADDR);
    writeEEPROM(100,battv_ADDR); //10Volts
    writeEEPROM(3,ch_toggle_ADDR);
    writeEEPROM(1,OSD_RSSI_RAW_ADDR);
    writeEEPROM(1,AUTO_SCREEN_SWITCH_ADDR);
    writeEEPROM(1,PAL_NTSC_ADDR);
    writeEEPROM(1,OSD_BRIGHTNESS_ADDR);
}
void readSettings() {
